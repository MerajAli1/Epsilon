...
const generateLabelsByTimeframe = (timeframe) => {
    ...
    if (timeframe === "24h") {
        ...
        for (let i = 3; i >= 0; i--) {
            // Current week and 3 weeks prior
...
const generateConsumptionData = (timeframe, length) => {
    ...
    for (let i = 0; i < length; i++) {
        let value;
        if (timeframe === "24h") {
            if (i >= 0 && i < 6) value = getRandomInt(50, 150); // Early morning/night
            else if (i >= 6 && i < 12) value = getRandomInt(150, 300); // Morning
            else if (i >= 12 && i < 18) value = getRandomInt(200, 350); // Afternoon
            else value = getRandomInt(250, 400); // Evening/Night
        } else if (timeframe === "week") {
            // Daily consumption for a week (e.g., 2 kWh to 5 kWh per day)
            // Assuming these are aggregated Watts for the day, or can represent kWh directly for daily totals
            value = getRandomInt(2000, 5000);
        } else if (timeframe === "month") {
            // Weekly consumption for a month (e.g., 10 kWh to 25 kWh per week)
            value = getRandomInt(10000, 25000);
        }
        data.push(value);
    }
    return data;
...
const IR = () => {
    ...
    return (
        <>
            ...
            >
                {/* Combined Layout - Left and Right Aligned */}
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <div className="d-flex align-items-center mb-2 flex-wrap">
                                                <div className="me-3 mb-1">
                                                    ...
                                                    <div className="fw-bold">{currentReading}</div>
                                                </div>
                                                <div className="me-3 mb-1">
                                                    <div className="text-muted small">Voltage</div>
                                                    <div className="fw-bold">{voltageReading}</div>
                                                </div>
                                                <div className="mb-1">
                                                    <div className="text-muted small">Power</div>
                                                    <div className="fw-bold">{powerReading}</div>
                                                </div>
                                            </div>
                ...
                <div className="container py-4">
                    ...
                    >
                        ...
                        <div className="d-flex mb-3">
                            <button
                                className={`btn ${activeView === "usage"
                                        ? "btn-outline-primary"
                        ...
                        <div className="d-flex justify-content-end mb-2">
                            <button
                                className={`btn btn-sm ${timeframe === "24h" ? "btn-primary" : "btn-outline-secondary"
                                    } me-1`}
                            ...
                            <button
                                className={`btn btn-sm ${timeframe === "week" ? "btn-primary" : "btn-outline-secondary"
                                    } me-1`}
                            ...
                            <button
                                className={`btn btn-sm ${timeframe === "month"
                                        ? "btn-primary"
                                        : "btn-outline-secondary"
                                    }`}
